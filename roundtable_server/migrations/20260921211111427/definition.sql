...
--
-- Class Machine as table machine
--
...
--
-- Class MachineMetric as table machine_metric
--
...
CREATE TABLE "task" (
    ...
    "lastProgressAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);

--
-- Class TaskFeedback as table task_feedback
--
...
--
-- Class TaskLogEntry as table task_log_entry
--
...
--
-- Class TaskQuestion as table task_question
--
...
--
-- Foreign relations for "agent" table
--
...
--
-- Foreign relations for "machine_metric" table
--
...
--
-- Foreign relations for "task_feedback" table
--
...
--
-- Foreign relations for "task_log_entry" table
--
...
--
-- Foreign relations for "task_question" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('roundtable', '20260921211111427', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260921211111427', "timestamp" = now();
